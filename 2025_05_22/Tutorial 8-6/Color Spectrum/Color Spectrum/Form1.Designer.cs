namespace Color_Spectrum
{
    partial class Form1
    {
        ...
        /// 清理所有正在使用的資源。  
        /// </summary>  
        /// <param name="disposing">如果應釋放托管資源，則為 true；否則為 false。</param>  
        ...
        #region Windows 表單設計生成的代碼  

        /// <summary>  
        /// 設計工具支持所需的方法 - 請勿使用代碼編輯器修改此方法的內容。  
        /// </summary>  
        private void InitializeComponent()
        {
            ...
            this.promptLabel.Size = new System.Drawing.Size(125, 12);
            this.promptLabel.TabIndex = 7;
            this.promptLabel.Text = "選擇光譜中的一種顏色";
            // 
            // colorLabel
            // 
